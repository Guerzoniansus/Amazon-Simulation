...
walls.push(createWall(4, y, 0.35, 0, wallshape1, materialwall1));
walls.push(createWall(4, 0.05, 0.35, 0, paddingshape1, materialpadding));
walls.push(createWall(7.65, y, 6, ninetydegrees, wallshape2, materialwall2));
walls.push(createWall(7.65, 0.05, 6, ninetydegrees, paddingshape2, materialpadding));
walls.push(createWall(4, y, 11.65, 0, wallshape1, materialwall1));
walls.push(createWall(4, 0.05, 11.65, 0, paddingshape1, materialpadding));
walls.push(createWall(0.35, y, 9.7, ninetydegrees, wallSection, materialwallSection));
walls.push(createWall(0.35, 0.05, 9.7, ninetydegrees, paddingSection, materialpadding));
walls.push(createWall(0.35, y, 2.3, ninetydegrees, wallSection, materialwallSection));
walls.push(createWall(0.35, 0.05, 2.3, ninetydegrees, paddingSection, materialpadding));
walls.push(createWall(0.15, 3.45, 6, ninetydegrees, gateSection, materialgate));
